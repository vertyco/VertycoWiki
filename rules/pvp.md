...
## 3️⃣ Player Interaction Rules

- **3.1 - Mass Bob Caging**
  - *Caging multiple new players.*
  - **First Offense**: Cage area destruction and formal warning.
  - **Second Offense**: Full structure wipe.

- **3.2 - Cable/Structure Spam**
  - *Excessive spam (e.g., cables) causing lag or placed without purpose near a base.*
  - **First Offense**: Warning and 24 hours to remove spam.
  - **Second Offense**: Spam removal and formal warning.
  - **Third Offense**: Spam removal and Ark data wipe.
  - **Fourth Offense**: Spam removal and <span style="color: orange;">7-day temp ban</span>.
...
- **Wipe Schedule**: Bi-monthly on the first Friday of February, April, June, August, October, and December.
- **Current Season**: [Check the #📕｜pvp-rules channel](https://discord.com/channels/625757527765811240/650999675779809300/870293697957330974)
